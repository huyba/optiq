...
struct topology_interface topology_xe6 =
{
    ...
    .optiq_topology_read_topology_from_file = optiq_topology_read_topology_from_file_xe6,
    .optiq_topology_get_topology = optiq_topology_get_topology_xe6,
    .optiq_topology_get_node = optiq_topology_get_node_xe6,
    .optiq_topology_finalize = optiq_topology_finalize_xe6
}

void optiq_topology_init_xe6()
{
    int rc;
...
void optiq_topology_compute_neighbors_xe6(struct topology *self, int *coord, struct optiq_neighbor *neighbors, int *num_neighbors) 
{
...
void optiq_topology_get_topology_xe6(struct topology *self) 
{
...
void optiq_topology_get_node_xe6(struct topology *self, struct optiq_node *node, int num_dims)
{
