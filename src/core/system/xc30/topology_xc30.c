...
void optiq_topology_get_rank_xc30(struct topology *self, int *rank)
{
...
void optiq_topology_get_num_ranks_xc30(struct topology *self, int *num_ranks)
{
    optiq_topology_init_xc30();
    int rc, num_ranks;
...
void optiq_topology_get_nic_id_xc30(struct topology *self, uint16_t *nid)
{
    int rc, rank;
...
void optiq_topology_get_coord_xc30(struct topology *self, int *coord)
{
    uint16_t nid;
...
void optiq_topology_get_node_id_xc30(struct topology *self, int *coord, int *node_id)
{
}

void optiq_topology_get_all_coords_xc30(struct topology *self, int **all_coords, int num_ranks)
{

}

void optiq_topology_get_all_nic_ids_xc30(struct topology *self, int *all_nic_ids, int num_ranks)
{

}

void optiq_topology_get_size_xc30(struct topology *self, int *size)
{
}

void optiq_topology_get_torus_xc30(struct topology *self, int *torus)
{
}

void optiq_topology_get_bridge_xc30(struct topology *self)
{
...
void optiq_topology_get_topology_xc30(struct topology *self) 
{
    ...
    self->num_dims = 3;
    optiq_topology_get_num_ranks_xc30(&self->num_ranks);

    self->all_coords = (int **)malloc(sizeof(int *) * self->num_ranks);
    for (int i = 0; i < self->num_ranks; i++) {
	self->all_coords[i] = (int *)malloc(sizeof(int) * self->num_dims);
    }
    optiq_topology_get_all_coords_xc30(self->all_coords, self->num_ranks);
...
void optiq_topology_finalize_xc30(struct topology *self)
{
}
