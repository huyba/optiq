...
As we see in the Table \ref{table:random_1024}, the varying average distance (Dist) between sources and destinations shows the random pairing in different configurations. In all cases, the performance of all 3 approaches in 3 patterns is varied. However, Optimization and Heuristic approaches both outperform MPI\_Alltoallv. The experiment shows that even we randomize pairing of sources and destination, we still are able to achieve better performance.
