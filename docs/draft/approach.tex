...
\begin{center}
    ...
    Heuristic 3 & $O$(K * (Time complexity of the algrithms used to get k shortest paths)) & Sparse comminication \\ \hline
    Path-based model & $O$(K * (Time complexity of the algrithms used to get k shortest paths) + Solving time) & Medium dense where proportional throughtput can be gained \\
    \hline
    \end{tabular}
