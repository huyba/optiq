...
set lmarg 5
set rmarg 2
set output "subset_512.ps"
set title "Transfer bandwidth for MPI_Alltoallv and OPTIQ \n Subset pattern, 512 nodes, 1 rank/node, message size = 8 MB" font ",22"
set logscale y 10
...
set xtics () font ",23"
set ytics ("8" 8192, "16" 16384, "32" 32768, "64" 65536, "128" 131072, "256" 262144, "512" 524288, "1024" 1048576) font ",23"
