...
plot "64k.dat" using 1:10 ls 1 title "          Chunk size = 64K" with linespoints, \
"128k.dat" using 1:10 ls 2 title "Chunk size = 128K" with linespoints, \
"32k.dat" using 1:10 ls 3 title "  Chunk size = 32K" with linespoints
