...
set lmarg 2
set rmarg 2
set output "heu_paths_disjoint.ps"
set title "Transfer bandwidth for Heuristics in 3 patterns 1K with different max load - Disjoint" font ",22"
set logscale y 10
...
"heu_mx32_64k.dat" using 1:11 ls 7 title "     OPTIQ Heuristics Ma Load = 32" with linespoints
