...
plot \
"opt_87.dat" using ($10/4.0):12 ls 4 title "          Subset - OPTIQ Optimization" with linespoints, \
"heu_ml4_87.dat" using ($10/4.0):12 ls 1 title "     Subset - OPTIQ Heuristics" with linespoints, \
"mpi_87.dat" using ($10/4.0):12 ls 2 title "     Subset - MPI_Alltoallv" with linespoints
