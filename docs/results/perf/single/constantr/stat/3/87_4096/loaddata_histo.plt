...
set xtics ("64K" 16, "128K" 17, "256K" 18,  "512K" 19, "1M" 20, "2M" 21, "4M" 22, "8M" 23, "16M" 24, "32M" 25, "64M" 26, "128M" 27) font ",22"
set ytics () font ",22"
...
#count and plot
plot "opt_loaddata_87_64k.dat" u (hist($1,width)):($2) smooth freq w boxes ls 1 title "       Optimization", \
"heu_ml4_loaddata_87_64k.dat" u (hist($1,width)+width):($2) smooth freq w boxes ls 2 title "       Heuristics Max Load = 4", \
"mpi_loaddata_87_64k.dat" u (hist($1,width)+2*width):($2) smooth freq w boxes ls 3 title "       MPI_Alltoallv"
