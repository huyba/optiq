...
#count and plot
plot "opt_copies_3_64k.dat" u (hist($1,width)):($2) smooth freq w boxes ls 1 title "       Optimization", \
"heu_ml4_copies_3_64k.dat" u (hist($1,width)+width):($2) smooth freq w boxes ls 2 title "Heuristics Max Load = 4"
