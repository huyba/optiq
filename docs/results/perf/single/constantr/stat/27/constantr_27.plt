...
plot \
"opt_27.dat" using ($10/4.0):12 ls 4 title "          Subset - OPTIQ Optimization" with linespoints, \
"heu_ml4_27.dat" using ($10/4.0):12 ls 1 title "     Subset - OPTIQ Heuristics" with linespoints, \
"mpi_27.dat" using ($10/4.0):12 ls 2 title "     Subset - MPI_Alltoallv" with linespoints
