...
plot "opt16m.dat" using 1:5 ls 1 title "          OPTIQ Optimization Message size = 16M" with linespoints, \
"opt16m.dat" using 1:3 ls 2 title "          MPI_Alltoallv Message size = 16M" with linespoints, \
"opt4m.dat" using 1:5 ls 3 title "          OPTIQ Optimization Message size = 4M" with linespoints, \
