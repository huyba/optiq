...
\label{fig:patterns}
\end{figure}
%\item Disjoint: is many-to-many communication pattern where the sources and destinations are separated. It is a typical pattern in many applications.
...
%We carried out a set of experiments to study the system's behavior in various patterns and to demonstrate throughput improvement.
