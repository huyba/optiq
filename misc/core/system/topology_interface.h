...
struct topology_interface {
    ...
    void (*optiq_topology_get_node_id)(struct topology_info *topo, int *node_id);
    void (*optiq_topology_get_node_id_from_coord)(struct topology_info *topo, int *coord, int *node_id);
    ...
    void (*optiq_topology_get_all_node_ids)(struct topology_info *topo, int *all_node_ids);
