...
void optiq_graph_construct_xe6(struct topology_info *topo_info, optiq_graph *graph)
{
...
void optiq_graph_coarsen_xe6(struct optiq_graph *graph)
{

}

void optiq_graph_uncoarsen_xe6(struct optiq_graph *graph)
{

}

struct graph_interface graph_xe6 =
{
    .optiq_graph_init = optiq_graph_init_xe6,
    .optiq_graph_construct = optiq_graph_construct_xe6,
    .optiq_graph_coarsen = optiq_graph_coarsen_xe6,
    .optiq_graph_uncoarsen = optiq_graph_uncoarsen_xe6
}
